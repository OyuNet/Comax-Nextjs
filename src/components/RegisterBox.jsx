...
export default function RegisterBox({isRegVisible, setIsRegOpen, clickRegister}) {

    return(
        <div>
            {isRegVisible && <Paper class="rounded-md bg-green-200 p-4 m-4 backdrop-blur-md">
                <div>
                    <div class="flex">
                        <button onClick={setIsRegOpen}>
                            <ArrowBack />
                        </button>
                        <h1 class="grow text-center">Aramıza Hoş Geldin!</h1>
                    </div>
